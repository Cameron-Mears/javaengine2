 ...
 * @author Cameron
 *
 * 	Combination of HashMap and a AVL tree
 * 	insert -> log(n)
 *  delete -> log(n)
 *  find() -> O(1)
 *  
 ...
 */public class HashTreeMap<Key extends Comparable<Key>, Value>
 {
	    ...
	    private void inOrderTraverse(TraverseFunction<Value> traverse, Node n)
	    {
	    	if (n.left != null) inOrderTraverse(traverse, n.left);
	    	traverse.apply(n.val);
